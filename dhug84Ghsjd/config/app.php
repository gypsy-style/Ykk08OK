...
return [
    ...
    'order_liff_id' => env('LIFF_ID_ORDER'),
    'order_register_liff_id' => env('LIFF_ID_ORDER_REGISTER'),
    'register_liff_id' => env('LIFF_ID_REGISTER'),
    'order_history_liff_id' => env('LIFF_ID_ORDER_HISTORY'),
    'register_merchant_liff_id' => env('LIFF_ID_MERCHANT_REGISTER'),
    'edit_merchant_liff_id' => env('LIFF_ID_MERCHANT_EDIT'),
    ...
    'richmenu_id4' => env('RICHMENU_ID_4'),
